...
export function InteractiveStatistics({
  ...
  useEffect(() => {
    const points = regionalMedicationData.map((region) => {
      ...
      const criticalCount = region.medicationNeeds.filter(
        ...
        <CardHeader>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <CardDescription>
                Interactive visualization of global medication needs
              </CardDescription>
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Explore medication needs across crisis-affected regions.
                      Hover over points to see details and click to view
                    ...
                    <div className="mt-2 space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {(hoveredPoint.data.population / 1000000).toFixed(1)}M
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Displaced:</span>
                        <span className="font-medium">
                          {(
                            hoveredPoint.data.displacedPopulation / 1000
                          ).toFixed(0)}
                          K
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {
                            hoveredPoint.data.medicationNeeds.filter(
                              (m: any) => m.urgency === "critical"
                            ).length
                          }
                        </span>
                      </div>
                          ...
                          <div className="flex justify-between items-center">
                            <div>
                              ...
                              <CardDescription>
                                ...
                                Displaced:{" "}
                                {(region.displacedPopulation / 1000).toFixed(0)}
                                K
                              </CardDescription>
                            </div>
                            <Badge
