...
import { LucideUsers, LucideClipboard, LucideBell, LucideArrowUpRight, LucideHeart, LucideActivity } from "lucide-react"
        ...
        const fetchData = () => {
            ...
            for (let i = 0; i < 30; i++) {
                points.push({
                    ...
                    color: "#f04e59",
                    size: 1.5,
                    label: `Life saved in ${["Syria", "DR Congo", "Bangladesh", "Yemen", "Haiti", "Afghanistan", "South Sudan", "Nigeria"][Math.floor(Math.random() * 8)]}`,
                    data: {
                        condition: ["Respiratory Infection", "Malaria", "Diarrheal Disease", "Malnutrition", "Trauma/Injury"][
                ...
                <CardContent className="pt-0">
                    <div className="relative flex flex-col items-center">
                        <div className="relative h-64 w-64 mx-auto">
                            <InteractiveGlobe points={globePoints} size="small" onPointHover={setHoveredPoint} />
                            ...
                            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                                <div className="bg-black/30 backdrop-blur-sm rounded-full h-20 w-20 flex flex-col items-center justify-center">
                                    <span className="text-white text-xl font-bold">{livesSaved.toLocaleString()}</span>
                ...
                <CardContent className="pt-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div className="bg-gradient-to-br from-blue-50 to-white p-4 rounded-lg">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <Badge className="bg-primary">+{(peopleHelped - livesSaved).toLocaleString()}</Badge>
                            </div>
                            <div className="text-2xl font-bold">{peopleHelped.toLocaleString()}</div>
                            <div className="text-xs text-muted-foreground mt-1">Total patients who received guidance</div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-white p-4 rounded-lg">
                            ...
                            <div className="text-xs text-muted-foreground mt-1">Since your last login (8 hours ago)</div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            {[1, 2, 3].map((_, i) => (
                                <div key={i} className="flex items-center p-2 rounded-lg border">
