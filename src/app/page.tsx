...
import { LucideHeartPulse, LucideUsers, LucideBrain, LucideActivity } from "lucide-react"
          ...
          <div className="container px-4 md:px-6 relative z-10">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-gemini-gradient text-primary-foreground shadow hover:bg-primary/80 mb-4">
                ...
                <p className="text-muted-foreground md:text-xl">
                  DDXAi bridges the gap between patients seeking medical guidance and volunteer clinicians worldwide.
              ...
              <div className="relative h-[350px] rounded-[24px] overflow-hidden gemini-border flex items-center justify-center bg-white">
                <div className="absolute inset-0 bg-grid-pattern-light opacity-10"></div>
                <div className="relative z-10 p-6 text-center">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gemini-gradient flex items-center justify-center">
                    <LucideHeartPulse className="h-8 w-8 text-white" />
                  </div>
                  <h3 className="text-xl font-medium mb-2">How DDXAi Works</h3>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <Card className="gemini-card border-none">
                <CardHeader>
                  <div className="p-2 w-12 h-12 rounded-full bg-gemini-blue-gradient flex items-center justify-center mb-4">
              ...
              <Card className="gemini-card border-none">
                <CardHeader>
                  <div className="p-2 w-12 h-12 rounded-full bg-gemini-green-gradient flex items-center justify-center mb-4">
              ...
              <Card className="gemini-card border-none">
                <CardHeader>
                  <div className="p-2 w-12 h-12 rounded-full bg-gemini-red-gradient flex items-center justify-center mb-4">
        ...
        <div className="container flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-2">
            <div className="relative h-6 w-6 overflow-hidden">
              <div className="absolute inset-0 bg-gemini-gradient rounded-full"></div>
              <div className="absolute inset-1 bg-white rounded-full flex items-center justify-center">
                <LucideHeartPulse className="h-3 w-3 text-primary" />
              </div>
            </div>
            <span className="text-lg font-semibold">DDXAi</span>
          </div>
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} DDXAi. All rights reserved. Not a substitute for professional medical
            advice.
          </p>
